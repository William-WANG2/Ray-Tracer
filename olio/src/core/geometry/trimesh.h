...
public:
  ...
  Vec3r FaceNormal(TriMesh::Ptr mesh, TriMesh::FaceHandle fh);
  ...
  Vec3r FaceNormal(TriMesh::FaceHandle fh, bool is_normalize=true);
  Vec3r VertexNormal(TriMesh::VertexHandle vh, bool is_normalize=true);
